...
contour/lev=(-inf)(-0.8,0.8,0.1)(inf)/o correl ; go fland
frame/file=eof.annual.${MODEL}.correl.gif
...
cdo selseas,1 -seldate,1970-12-01,1999-11-30 anom.$MODEL.70.99.nc $MODEL.DJF.70.99.nc
cdo selseas,2 -seldate,1970-12-01,1999-11-30 anom.$MODEL.70.99.nc $MODEL.MAM.70.99.nc
cdo selseas,3 -seldate,1970-12-01,1999-11-30 anom.$MODEL.70.99.nc $MODEL.JJA.70.99.nc
cdo selseas,4 -seldate,1970-12-01,1999-11-30 anom.$MODEL.70.99.nc $MODEL.SON.70.99.nc
...
contour/lev=(-inf)(-0.8,0.8,0.1)(inf)/o correl ; go fland
frame/file=eof.${TRI}.${MODEL}.correl.gif
...
frame/file=eof.${TRI}.${MODEL}.pc.gif
